...
async function resolveShortUrl(shortUrl) {
  ...
  const bvMatch = location.match(/\/video\/(BV[0-9a-zA-Z]+)/);
...
async function parseBilibili(input) {
  console.log('[B站] 解析链接:', input);
